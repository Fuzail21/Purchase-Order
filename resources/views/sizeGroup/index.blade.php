...
@section('content')
        ...
        <div class="flex justify-between mb-6">
            <h1 class="text-3xl font-bold">Size Group List</h1>
        ...
        <div class="mt-6">
            {{ $sizeGroup->links('pagination::tailwind') }}
        </div>
    </div>
    ...
    <div id="packModal" class="fixed inset-0 hidden bg-black bg-opacity-50 flex items-center justify-center">
        <div class="bg-white w-full max-w-md rounded-lg shadow-lg p-6 relative">
            ...
            <h2 class="text-xl font-bold mb-4">Add New Size Group</h2>
            
            <form action="{{ route('size.store') }}" method="POST" class="space-y-4">
                @csrf
                <input type="text" name="name" placeholder="Size Group Name"
